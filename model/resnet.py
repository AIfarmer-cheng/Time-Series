...
def resnet34(num_classes=1000, include_top=True, input_channels=3):
    # https://download.pytorch.org/models/resnet34-333f7ec4.pth
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes=num_classes, include_top=include_top, input_channels=input_channels)
